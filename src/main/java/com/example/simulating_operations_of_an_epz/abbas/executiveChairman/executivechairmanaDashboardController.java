...
public class executivechairmanaDashboardController
{
    ...
    @javafx.fxml.FXML
    public void ChairmanLogoutOnActionButton(ActionEvent actionEvent) throws IOException {
    ...
    @Deprecated
    public void goal1SceneChangeActionButton(ActionEvent actionEvent) throws IOException {
        Parent scene2Parent = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("/com/example/simulating_operations_of_an_epz/abbas/executiveChairman/goal1.fxml")));
        Scene scene2 = new Scene(scene2Parent);
        Stage window = (Stage)((Node)actionEvent.getSource()).getScene().getWindow();
    ...
    @javafx.fxml.FXML
    public void ViewStrategicGoalsIOnActionButton(ActionEvent actionEvent) throws IOException {
    ...
    @javafx.fxml.FXML
    public void chairmanNotedOnActionButton(ActionEvent actionEvent) throws IOException {
    ...
    @javafx.fxml.FXML
    public void internalPolicesOnActionButton(ActionEvent actionEvent) throws IOException{
    ...
    @javafx.fxml.FXML
    public void kpiRecordsOnActionButton(ActionEvent actionEvent) throws IOException {
    ...
    @javafx.fxml.FXML
    public void operationalMetricsOnActionButton(ActionEvent actionEvent) throws IOException {
    ...
    @javafx.fxml.FXML
    public void longTermVisionStatementOnActionButton(ActionEvent actionEvent) throws IOException {
    ...
    @javafx.fxml.FXML
    public void reviewYearlybudgetOnActionButton(ActionEvent actionEvent) throws IOException {
